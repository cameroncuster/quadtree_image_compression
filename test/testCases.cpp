...
TEST_CASE( "Test Quadtree returns correct greyscale image for checkerboard image with decrement threshold" )
{
    unsigned i, j;
    unsigned width = 4;
    unsigned height = 4;
...
TEST_CASE( "Test Quadtree returns correct greyscale image for checkerboard image with increment threshold" )
{
    unsigned i, j;
    unsigned width = 4;
    unsigned height = 4;
